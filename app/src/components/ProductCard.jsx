...
import { countComponents } from '../teamTypes'
...
export default function ProductCard({ product, groupColour, onClick }) {
  ...
  const componentCount = countComponents(product.components)
  ...
  return (
    ...
    >
      ...
      <div className="p-4 pt-5">
        ...
        {componentCount > 0 && (
          <div className="mt-3 inline-flex items-center gap-1.5 text-xs font-medium text-gds-blue bg-gds-blue/5 border border-gds-blue/20 rounded px-2 py-1">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h7" />
            </svg>
            <span>{componentCount} components &amp; platforms</span>
          </div>
        )}
      </div>
    </button>
